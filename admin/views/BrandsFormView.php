...
<body>
    <form class="formBrands" action="<?php echo $action ?>" enctype="multipart/form-data" method="post">
    <div class="d-flex justify-content-between mt-2 mb-2" >
        <a class="btn btn-info" href="index.php?controller=brands">Quay Lại</a> 
    </div>
    <div class="panel panel-default border rounded ">
          <div class="panel-heading rounded-top  bg-primary">
                <h3 class="panel-title p-2 text-white m-0"><span class="add">Thêm</span> <span class="update">Sửa</span> Thương Hiệu</h3>
          </div>
    ...
    <script>
        ...
        console.log(update);
        var form = document.querySelector(".formBrands");
        var action = form.getAttribute("action");
        if(action === "index.php?controller=brands&action=createPost")
        {
