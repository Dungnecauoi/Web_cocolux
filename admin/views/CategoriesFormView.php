...
<body>
    ...
    <div class="panel panel-default border rounded ">
          <div class="panel-heading rounded-top  bg-primary">
                <h3 class="panel-title p-2 text-white m-0"><span class="add">Thêm</span> <span class="update">Sửa</span> Danh Mục Sản Phẩm</h3>
          </div>
          <div class="panel-body">
                ...
                <div class="input-group m-2 d-flex align-items-center">
                    <div class="input-group-addon text-uppercase " style="width:15%;font-weight:600">Ảnh ở cột sản phẩm </div>
                    <input type="file" name="photo_colum" class="mr-2" id="exampleInputAmount" value="" placeholder="name">
                </div>
                <?php 
                ...
                <div class="input-group m-2 d-flex align-items-center">
                    <div class="input-group-addon text-uppercase " style="width:15%;font-weight:600">Parent</div>
    ...
    <script>
        ...
        if(action === "index.php?controller=categories&action=createPost")
        {
