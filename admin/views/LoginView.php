...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="../assets/admin/images/cocolux/logo_ccs.svg" />
</head>
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST" action="index.php?page=admin&controller=login&action=doLogin">
                <?php echo $notify; ?>
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" name="email" id="exampleInputEmail1" placeholder="Username/Email">
                </div>
                <div class="form-group">
