...
<body>
    ...
    <div class="d-flex justify-content-between mt-2 mb-2" >
        <a class="btn btn-info" href="index.php?controller=logo">Quay Lại</a> 
    </div>
    <div class="panel panel-default border rounded ">
          ...
          <div class="panel-body">
                <div class="input-group m-2 d-flex align-items-center">
                    <div class="input-group-addon text-uppercase " style="width:15%;font-weight:600">Logo</div>
                    <input type="file" name="photo" class="mr-2" id="exampleInputAmount" value="" placeholder="name">
                </div>
                <div class="input-group m-2 d-flex align-items-center">
                    <div class="input-group-addon text-uppercase " style="width:15%;font-weight:600">Logo Sub</div>
                    <input type="file" name="photoSub" class="mr-2" id="exampleInputAmount" value="" >
                </div>
    ...
    <script>
        ...
        if(action === "index.php?controller=logo&action=createPost")
        {
